    ...
    <center>
        <div class="container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <br>
                <input type="text" name="Location" placeholder="Area" style="font-size: 24px;">

                <button type="submit" name="search_location" style="font-size: 24px;">Search Hospital By Area</button>
            </form>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && (isset($_POST["search_hospital"]) || isset($_POST["search_location"]))) {
                    ...
                    if (isset($sql)) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td style='font-size: 18px;'>" . $row["area"] . "</td>";
                                echo "<td style='font-size: 18px;'>" . $row["find_location"] . "</td>";
                                echo "<td style='font-size: 18px;'>" . $row["hotline_number"] . "</td>";
                                echo "</tr>";
                            }
                            echo "</table>";
                        } else {
                ...
                elseif (isset($_POST["Location"]) && !empty($_POST["Location"])) {
                    ...
                    $sql = "SELECT * FROM hospital WHERE area LIKE '%$Location%'";
                ...
                echo "<br><a href=\"hospital_viewer1.php\" style=\"font-size: 24px;\">See Full List</a>";
            } else {
